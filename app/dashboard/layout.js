...
/**
 * Dashboard layout wrapper - protects routes and provides app structure
 * Handles auth check, loading state, and wraps children with inventory context
 */
export default function DashboardLayout({ children }) {
  ...
  // Render main dashboard layout with navbar and inventory context
  return (
    <InventoryProvider>
